            ...
            ?>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="date" autocomplete="no" class="form-control" name=fechanacimiento id="exampleFormControlInput1"
                    ...
                    <div class="form-group">
                        ...
                        <textarea autocomplete="no" class="form-control" id="descripción" name=descripcion placeholder="Descripción" rows="5"
