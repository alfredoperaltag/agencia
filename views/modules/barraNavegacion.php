...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <a class="navbar-brand" href="index.php?action=inicio">
    <font style="vertical-align: inherit;">
      <font style="vertical-align: inherit;">Davidtours</font>
    </font>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.php?action=nosotros">
          <font style="vertical-align: inherit;">
    ...
    <form action="controladorBuscar.php" method="GET" class="form-inline mt-2 mt-md-0">
      <input class="form-control mr-sm-2" for="caja_busqueda" type="text" placeholder="Buscar" aria-label="Search" name="palabraBuscada"
        autocomplete="off" />
